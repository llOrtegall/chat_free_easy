...
while True:
  ...
  for nameTelefono, ipTelefono in dirrecionesIP.items():
    ...
    elif(Acount_01.__contains__('Error de registo' or 'Error') and Acount_02.__contains__('Desactivado')):
    ...
    elif(Acount_02.__contains__('Error de registo' or 'Error') and Acount_01.__contains__('Desactivado')):
