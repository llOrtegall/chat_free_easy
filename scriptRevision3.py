...
driver.get('http://'+IngresarIp+'/servlet?p=login&q=loginForm&jumpto=status')
...
if(res1 == res2):
  ...
  try:
    ...
    cuenta.click()
    time.sleep(1) # tiempo para cargar la cuenta
...
if(Acount_01.__contains__('Error de registo')):
  ...
  print("Ninguna Cuenta Tiene Error Status: OK ")